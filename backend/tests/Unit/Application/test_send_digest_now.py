...
async def test_sends_digest_and_records_sent_history() -> None:
    ...
    uc = SendDigestNow(
        digest_assembler=assembler, renderer=FakeRenderer(), mailer=mailer, digest_history_repository=history_repo
    )
...
async def test_user_not_found_propagates_and_records_no_history() -> None:
    ...
    history_repo = FakeDigestHistoryRepository()
    uc = SendDigestNow(
        digest_assembler=assembler, renderer=FakeRenderer(), mailer=FakeMailer(), digest_history_repository=history_repo
    )
